package {
    ...
    public class SiteLock
    {
        ...
        public static function setRedirect(url:String):void {
			redirectUrl = url;
			trace("[SiteLock] Setting redirect to: " + redirectUrl);
		}
        /**
        ...
        public static function checkURL(destroy:Boolean = false ):Boolean
        {
			...
			var checkString:String = ("[SiteLock] " +  ((protocol == "file")?"The .swf is locally hosted.": "This .swf is hosted at " + domain));

			var startOfDomain:String = domain.substring(0, 4);

			if (startOfDomain == "www.") {
            ...
            { 
                ...
                navigateToURL(new URLRequest("http://www.rixium.com&url=" + domain), '_blank');
